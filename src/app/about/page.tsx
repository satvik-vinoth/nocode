  ...
  return (
    <div className="bg-gradient-to-r from-black to-gray-800 min-h-screen">
      ...
      {!dataset ? (
                    ...
                    <div className="mt-6 w-[65%] p-6 rounded-lg bg-gray-800 ">
                        ...
                        <button
                            className="mt-4 ml-2 bg-gradient-to-r from-black to-gray-800 text-white border border-white px-4 py-2 rounded-lg font-bold transition-transform duration-300 hover:scale-105 cursor-pointer"
